      ...
      return Padding(
        ...
        child: Center(
          child: PaginatedDataTable2(
            ...
            columns: [
              DataColumn2(label: Text("Produto"), fixedWidth: 200),
              DataColumn2(label: Text("Posição"), fixedWidth: 300),
              DataColumn2(label: Text("Descrição")),
              DataColumn2(label: Text("Categoria"), fixedWidth: 150),
              DataColumn2(label: Text("Qtd. Estoque"), fixedWidth: 150),
              DataColumn2(label: Text("Qtd. Min. Estoque"), fixedWidth: 150),
